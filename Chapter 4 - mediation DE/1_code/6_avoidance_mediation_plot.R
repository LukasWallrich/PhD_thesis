...
NAME <- '6_avoidance_mediation_plot' ## Name of the R file goes here (without the file extension!)

# ------------
# Sources
# ------------
if (!require("pacman")) install.packages("pacman")
pacman::p_load(tidyverse, DiagrammeR, DiagrammeRsvg)
...
graph_parameters <- read_rds(here(pipelinedir, "5_robustness_checks", "out", "graph_parameters.RDS"))
...
'x2' [label = <Neg. attitude re <br /> foreigners>, color = 'black', shape = 'rectangle', height = '0.5', width = '1.5', pos = '2.5,0.3!']


'y' [label = <Avoidance <br /> intentions>, color = 'black', shape = 'rectangle', height = '0.5', width = '1.5', pos = '5,1.2!']
